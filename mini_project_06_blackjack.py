# Mini-project #6 - Blackjack Coursera
...
# draw handler    
def draw(canvas):
    canvas.draw_text("BLACKJACK", (110, 70), 50, "RED")
    canvas.draw_text(player2String, (26, 185), 30, "Black")
    canvas.draw_text(player1String, (26, 385), 30, "Black")
