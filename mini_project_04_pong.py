...
def draw(c):
    ...
    c.draw_line([half_width, 0],[half_width, height], 2, "black")
    c.draw_line([pad_width, 0],[pad_width, height], 2, "black")
    c.draw_line([width - pad_width, 0],[width - pad_width, height], 2, "black")
    ...
    # draw ball
    c.draw_circle(ball_pos, ball_radius, 2, "Black", "Green")
    ...
    # draw paddles
    c.draw_polygon([[0, paddle1_pos], [pad_width, paddle1_pos],[pad_width, (paddle1_pos) + pad_height ],[0, (paddle1_pos) + pad_height]],1, "Blue", "white") 
    c.draw_polygon([[width, paddle2_pos], [width - pad_width, paddle2_pos], [width - pad_width, paddle2_pos + pad_height], [width, paddle2_pos + pad_height]],1, "Blue", "white")
    # draw scores
    c.draw_text(str(score1), [275, 100], 60, "red")    
    c.draw_text(str(score2), [485, 100], 60, "red")
